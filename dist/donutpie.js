...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Donut = __webpack_require__(157);
	...
	var Pies = _react2['default'].createClass({
	  displayName: 'Pies',

	  render: function render() {
	    return _react2['default'].createElement('div', null, _react2['default'].createElement(_Donut2['default'], { percent: 9, width: 50 }), _react2['default'].createElement(_Donut2['default'], { background: '#fff', percent: 50, piecolor: '#000', textcolor: '#000' }), _react2['default'].createElement(_Donut2['default'], { background: '#3498db', width: 150, percent: 78, piecolor: '#2980b9', textcolor: '#2980b9' }), _react2['default'].createElement(_Donut2['default'], { background: '#e74c3c', width: 200, percent: 89, piecolor: '#c0392b', textcolor: '#c0392b' }));
	  }
	});

	_reactDom2['default'].render(_react2['default'].createElement(Pies, null), document.getElementById('donutpie'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DonutPie = React.createClass({
	  displayName: 'DonutPie',
	  ...
	  render: function render() {
	    ...
	    return React.createElement('div', { style: { width: w, position: 'relative', display: 'inline-block' } }, React.createElement('span', { className: 'donut-text', style: { color: this.props.textcolor, 'fontSize': fontsize } }, this.props.percent), React.createElement('svg', { viewBox: '0 0 100 100', style: { background: this.props.background } }, React.createElement('circle', { r: '25', cx: '50', cy: '50', className: 'outer-circle', strokeDasharray: percent + ' 158', stroke: this.props.piecolor }), React.createElement('circle', { r: this.props.holeradius, cx: '50', cy: '50', className: 'inner-circle', fill: this.props.fill })));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./donut.css", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./donut.css");
